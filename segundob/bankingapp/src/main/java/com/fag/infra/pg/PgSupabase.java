...
public class PgSupabase implements IUserRepository {
    ...
    public UserAccountDTO createUser(UserAccountDTO dto) {
        ...
        String insertQuery = "INSERT INTO users (id, document, name, email, password, account_number, create_at, disable_at) "
                +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public UserAccountDTO findUserBy(String document) {
        ...
        String query = "SELECT id, document, name, email, password, account_number, create_at, disable_at FROM users WHERE document = '" + document + "';";
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    user.setCreateAt(resultSet.getObject("create_at", LocalDateTime.class));
                    user.setDisableAt(resultSet.getObject("disable_at", LocalDateTime.class));
