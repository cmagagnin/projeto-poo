...
public class CelcoinBassRepository implements IBassRepository{
    ...
    @Override
    public String pagarBoleto(BankslipDTO linhaDigitavel) throws Exception {
        ...
        String payLoad = "{\n" + //
                        ...
                        "  \"barCode\": {\n" + //
                        "    \"type\": 0,\n" + //
                        "    \"digitable\": \""+linhaDigitavel.getBarcode()+"\"\n" + //
                        "  },\n" + //
                        "  \"dueDate\": \"2021-05-25T00:00:00Z\",\n" + //
                        "  \"transactionIdAuthorize\": "+linhaDigitavel.getTransactionId()+"\n" + //
                        "}";
